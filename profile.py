...
node1.addService(rspec.Execute(shell="bash", command="sudo -n /local/repository/setup.sh"))
node2.addService(rspec.Execute(shell="bash", command="sudo -n /local/repository/setup.sh"))
node3.addService(rspec.Execute(shell="bash", command="sudo -n /local/repository/setup.sh"))
node4.addService(rspec.Execute(shell="bash", command="sudo -n /local/repository/setup.sh"))
