...
node1.addService(rspec.Execute(shell="sh", command="/local/repository/setup.sh"))
node2.addService(rspec.Execute(shell="sh", command="/local/repository/setup.sh"))
node3.addService(rspec.Execute(shell="sh", command="/local/repository/setup.sh"))
node4.addService(rspec.Execute(shell="sh", command="/local/repository/setup.sh"))
